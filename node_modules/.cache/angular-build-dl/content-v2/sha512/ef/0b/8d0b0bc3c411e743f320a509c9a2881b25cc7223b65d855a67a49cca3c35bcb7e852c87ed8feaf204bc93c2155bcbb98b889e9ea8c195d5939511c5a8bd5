  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-filter-filter-module"], {
    ...
    function srcAppPagesFilterFilterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var FilterPage = /*#__PURE__*/function () {
        function FilterPage(modalCrtl) {
          _classCallCheck(this, FilterPage);

          this.modalCrtl = modalCrtl;
          this.availableSizes = ['XS', 'S', 'M', 'L', 'XL'];
          this.brands = ['Academy', 'ACNE', 'Ator', 'Baby', 'Bec Bride'];
        }
...
//# sourceMappingURL=pages-filter-filter-module-es5.js.map