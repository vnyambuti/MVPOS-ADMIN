...
let LoginPage = class LoginPage {
    constructor(route, fb, httpservice) {
        this.route = route;
        this.fb = fb;
    ...
    onSubmit() {
        this.loading = true;
        this.httpservice.postWithoutHeadersData(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + 'login', this.loginForm.value).subscribe((res) => {
            console.log(res);
            if (res.success) {
                this.loading = false;
