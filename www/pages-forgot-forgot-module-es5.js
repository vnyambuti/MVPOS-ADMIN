  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-forgot-forgot-module"], {
    ...
    function srcAppPagesForgotForgotPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ForgotPage = /*#__PURE__*/function () {
        ...
        function ForgotPage(route, navCtrl, httpservice, fb) {
        ...
        _createClass(ForgotPage, [{
          ...
          key: "goToMobileVerify",
          value: function goToMobileVerify() {
          ...
          value: function sendRequest() {
            ...
            try {
              ...
              this.httpservice.postData(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].url + 'reset', this.emailForm.value).subscribe(function (g) {
                console.log(g);
                _this.loading = false;

                if (!g.success) {
                  _this.httpservice.presentToast(g.error);
                } else {
                  _this.httpservice.presentSuccessToast(g.message, 'bottom').then(function () {
                    _this.route.navigate(['/mobile-verify']);
                  });
                } // this.close()

              }, function (err) {
                _this.emailForm.valid;
                _this.loading = false;

                _this.httpservice.presentToast(err);
              });
            } catch (error) {
              this.loading = false;
