(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-product-detail-product-detail-module"], {
    ...
    function srcAppPagesProductDetailProductDetailPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _product_modal_product_modal_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./../product-modal/product-modal.page */
      ...
      var ProductDetailPage = /*#__PURE__*/function () {
        function ProductDetailPage(modalCrtl, navCtrl) {
          _classCallCheck(this, ProductDetailPage);

          this.modalCrtl = modalCrtl;
          this.navCtrl = navCtrl;
          this.colors = ['#F1F0F4', '#E5D2C4', '#deda97', '#b9ede0', '#DDE7F1', '#D6E6E0', '#BBBBBB', '#E6CBCA', '#e5d1eb'];
          this.availableSizes = ['XS', 'S', 'M', 'L'];
        }
        ...
        _createClass(ProductDetailPage, [{
          ...
          key: "chooseColor",
          value: function chooseColor(val) {
            this.currentColor = val;
          }
        }, {
          key: "chooseSize",
          value: function chooseSize(val) {
      ...
      ProductDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
