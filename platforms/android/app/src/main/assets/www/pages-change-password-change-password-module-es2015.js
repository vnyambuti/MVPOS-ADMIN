...
let ChangePasswordPage = class ChangePasswordPage {
    constructor(fb, route, router, httpservice) {
        this.fb = fb;
        this.route = route;
        this.router = router;
    ...
    newPassword() {
        try {
            this.loading = true;
            this.httpservice.postWithoutHeadersData(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].url + 'password-changed', this.passwordForm.value).subscribe((res) => {
                this.loading = false;
                if (!res.success) {
