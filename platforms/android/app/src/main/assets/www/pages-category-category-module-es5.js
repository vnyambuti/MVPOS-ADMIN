  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-category-category-module"], {
    ...
    function srcAppPagesCategoryCategoryPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CategoryPage = /*#__PURE__*/function () {
        ...
        function CategoryPage(route, navCtrl, httpservice, fb) {
          ...
          value: function sendCategory() {
            ...
            this.httpservice.postData(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].url + 'categories', this.categoryForm.value).subscribe(function (category) {
              if (category.success) {
                ...
                _this.httpservice.presentSuccessToast(category.message, 'bottom').then(function () {
                  _this.route.navigate(['/tabs/shop']);
                });
              } else {
