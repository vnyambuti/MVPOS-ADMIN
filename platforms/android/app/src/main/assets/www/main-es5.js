(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      // },
      {
        ...
        loadChildren: function loadChildren() {
          ...
          "pages-main-modal-main-modal-module").then(__webpack_require__.bind(null,
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() | pages-teller-teller-module */
          "pages-teller-teller-module").then(__webpack_require__.bind(null,
          /*! ./pages/teller/teller.module */
          "./src/app/pages/teller/teller.module.ts")).then(function (m) {
            return m.TellerPageModule;
          });
        }
      }];
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _pages_shop_shop_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _pages_shop_shop_page__WEBPACK_IMPORTED_MODULE_13__["ShopPage"], {
        ...
        _createClass(ShopPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.HTTP.getData(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].url + "shops").subscribe(function (shops) {
              ...
              if (shops.success) {
                _this2.shops = shops.data.shops[0];
                var store = JSON.stringify(_this2.shops);
                localStorage.setItem("shop", store);

                if (_this2.shops.tellers == 0) {
                  _this2.goToNewTeller();
                } else {
                  if (_this2.shops.categories.length == 0) {
                    _this2.goToNewCategory();
                  } else {
                    if (_this2.shops.products.length == 0) {
                      _this2.goToProduct();
                    } else {
                      _this2.cats = _this2.shops.categories;
                      _this2.products = _this2.shops.products;
                    }
                  }
                }
    ...
    function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var environment = {
        ...
        url: "https://33e1-102-217-144-110.ngrok.io/api/"
      };
      /*
